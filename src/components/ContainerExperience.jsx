                ...
                <div className="flex justify-between flex-col lg:flex-row w-[100%] p-0 m-0">
                    <div className="lg:bg-[#FF5555] w-full lg:w-4/12 border-r border-[#F8F8F2] m-0 p-3 rounded-tl-[50px]">
                        ...
                        <p className="text-justify">
                            ...
                            which was based on creating an institutional website for the ONG Parque Vivo. The main objective was to provide quick 
                            access to information on events and contacts with its members.
                        </p>
                    </div>
                    <div className="lg:bg-[#FF5555] w-full lg:w-4/12 border-r border-[#F8F8F2] m-0 p-3">
                        ...
                        <p className="text-justify">
                            I worked as a full-stack developer at the company, creating institutional websites, developing file management systems, 
                            creating platforms for LGPD-related issues, performing website maintenance, and improving management on e-commerce sites. 

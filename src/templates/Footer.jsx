            ...
            <div className="grid md:grid-cols-3 grid-cols-1 w-full mt-[10px] justify-center items-center">
                <div className="justify-center items-center text-center text-[#F8F8F2]">
                    ...
                    <div className="text-[1.5rem]">
                        <a href="https://www.linkedin.com/in/matheus-chiodi-b484581aa" target="_blank" rel="noopener noreferrer"  className="hover:text-[#FF5555]" title="Linkedin">
                            <i className="fab fa-linkedin"></i>
                        </a>
                        <a href="https://github.com/MatheusChiodi" target="_blank" rel="noopener noreferrer"  className="hover:text-[#FF5555] mx-2" title="Github">
                            <i className="fab fa-github-square"></i>
                        </a>
                        <a href="https://api.whatsapp.com/send/?phone=5516988400100&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer"  className="hover:text-[#FF5555]" title="Whatsapp">
                            <i className="fab fa-whatsapp-square"></i>
                        </a>
                    </div>
                    <p className="text-[0.8rem]">
                        <a href="mailto:matheuschiodi20@gmail.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF5555]" title="E-mail">

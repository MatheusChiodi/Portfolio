        ...
        <div className="w-full mx-auto m-0 p-0 lg:mb-[-80px] mb-0 lg:mt-0 mt-10" id="ContainerPortfolio">
            <div className="w-full lg:bg-slate-700 lg:pb-[100px] pt-[10px]">
                <div className="w-[95%] mx-auto m-0 p-0">
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 mx-auto m-0 p-0 w-full my-[5px] justify-center items-center">
                        <div className="w-[250px] h-[250px] mb-[10px] lg:bg-white bg-slate-700 rounded-t-[20px] rounded-b-[20px] card">
